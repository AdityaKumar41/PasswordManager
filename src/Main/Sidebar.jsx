...
const Sidebar = () => {
  return (
    <>
      <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-[calc(97vh)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5">
